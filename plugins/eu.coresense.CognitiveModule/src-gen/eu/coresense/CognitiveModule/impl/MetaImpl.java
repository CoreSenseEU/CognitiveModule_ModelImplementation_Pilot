 ...
 * </p>
 * <ul>
 *   <li>{@link eu.coresense.CognitiveModule.impl.MetaImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetaImpl extends MinimalEObjectImpl.Container implements Meta {
	...
	protected EClass eStaticClass() {
		return CognitiveModulePackage.Literals.META;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CognitiveModulePackage.META__NAME, oldName, name));
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link eu.coresense.CognitiveModule.impl.CoreImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CoreImpl extends MinimalEObjectImpl.Container implements Core {
	...
	protected EClass eStaticClass() {
		return CognitiveModulePackage.Literals.CORE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CognitiveModulePackage.CORE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CognitiveModulePackage.CORE__NAME:
			return getName();
		}

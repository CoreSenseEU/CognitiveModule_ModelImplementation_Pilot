 ...
 * </p>
 * <ul>
 *   <li>{@link eu.coresense.CognitiveModule.impl.CouplingImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CouplingImpl extends MinimalEObjectImpl.Container implements Coupling {
	...
	protected EClass eStaticClass() {
		return CognitiveModulePackage.Literals.COUPLING;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CognitiveModulePackage.COUPLING__NAME, oldName,
					name));
	}

 ...
 * @generated
 */
public class CognitiveModuleSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case CognitiveModulePackage.MODELET: {
			Modelet modelet = (Modelet) theEObject;
			T result = caseModelet(modelet);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case CognitiveModulePackage.COGNITIVE_MODULE: {
			CognitiveModule cognitiveModule = (CognitiveModule) theEObject;
			T result = caseCognitiveModule(cognitiveModule);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Modelet</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Modelet</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseModelet(Modelet object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cognitive Module</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cognitive Module</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCognitiveModule(CognitiveModule object) {
		return null;
	}
